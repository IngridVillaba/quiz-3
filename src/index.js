...
console.log("[Question #33]: ", stringVar.toLocaleLowerCase() === "hello"); // should print true

// 34. Check if 'booleanVar' is truthy.
if (booleanVar) {
  console.log("booleanVar is truthy");
} else {
  console.log("[Question #34]: ", "falsy");
}
...
console.log("[Question #36]: ", fruits.contains > 3); // should print true if it does, false if it does not
...
console.log("[Question #43]: ", fruits.includes("banana")); // should print true
...
console.log("[Question #56]: ", book.publishedYear);
/*
==========================
 Array
===========================
...
console.log("[Question #75]: ", maxCount <= 105);
...
if (book.genre) {
  console.log("[Question #79]:", "The genre property exists");
} else {
  console.log("[Question #79]:", "The genre property not exists");
}
...
let status = isVisible ? "visible " : "not visible";
